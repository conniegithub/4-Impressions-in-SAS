...
run;
*================================================================================;
%let xlsx = 'C:\Users\Yicong\Desktop\practice\impression data st.xlsx';
%let sheet1 = GMO_data;
...
could PCA be used on binary response?
*/
...
proc logistic data = Sheet plots(maxpoints = none) plots(only label) = (phat leverage dpc);
	class Inet_owner / param = ref;
	model response(event = '1') = age Yr_income Inet_owner;
run;
